...
- **Start here (tt-lang)**: [00_Main/00_Status/00_Quickstart.md](sdlc/00_Main/00_Status/00_Quickstart.md) — quick technical intro; status: [01_tt_metal/00_Status/00_projects_graph.md](sdlc/01_tt_metal/00_Status/00_projects_graph.md).
- **Python dialect layers (SoT)**: [00_Main/02_Architecture/08_PythonDialectLayersAndDataFlow.md](sdlc/00_Main/02_Architecture/08_PythonDialectLayersAndDataFlow.md) — Program / Graph / Compile / Runtime, data flow and transformation registry. Ideal data flow and target module structure: [00_Main/02_Architecture/20_IdealDataFlowAndModuleStructure.md](sdlc/00_Main/02_Architecture/20_IdealDataFlowAndModuleStructure.md).
