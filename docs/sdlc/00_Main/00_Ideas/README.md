...
- [20_nickel_mlir_config_abstract_engine.md](20_nickel_mlir_config_abstract_engine.md) — Nickel + MLIR для конфигураций абстрактного движка (Toy/Tenstorrent): типизированный конфиг (backend, graph, topology, objective), валидация через Pydantic (A) или MLIR config dialect (B).
- [21_ttnn_tensor_proxy_layer.md](21_ttnn_tensor_proxy_layer.md) — слой прокси для тензоров ttnn: типы определяются в tt-lang, ttnn опционален; валидация маппинга только при инициализации.
